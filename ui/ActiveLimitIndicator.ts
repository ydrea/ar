    ...
    <View style={styles.container} pointerEvents="none">
      ...
      {activeLimit === 'max' && (
        <Animated.View style={[styles.topIndicator, topIndicatorStyle]}>
          <View style={[styles.indicatorBadge, { borderColor: colors.primary }]}>
            ...
            <Animated.Text style={[styles.indicatorText, { color: colors.primary }]}>
              MAX DISTANCE
            </Animated.Text>
          </View>
        </Animated.View>
        ...
        <Animated.View style={[styles.rightIndicator, rightIndicatorStyle]}>
          <View style={[styles.indicatorBadge, { borderColor: colors.primary }]}>
            <Svg width={20} height={20} viewBox="0 0 24 24">
              ...
              <Path d="M21 21L17 17" stroke={colors.primary} strokeWidth={2} strokeLinecap="round" />
            </Svg>
            <Animated.Text style={[styles.indicatorText, { color: colors.primary }]}>
              CAMERA ZOOM
            </Animated.Text>
